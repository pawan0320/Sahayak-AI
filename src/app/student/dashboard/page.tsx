  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col">
        <Header title="My Learning Dashboard" />
        ...
        <main className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          >
            <h2 className="text-2xl font-bold mb-2">Welcome back, Aman!</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {stats.map((stat, index) => {
              ...
              return (
                ...
                >
                  <Card className={`p-6 border-border/50 hover:border-primary/50 transition bg-gradient-to-br ${stat.color}`}>
          ...
          >
            <Card className="p-6 border-border/50">
              <h3 className="text-lg font-semibold mb-4">Latest AI Notes</h3>
              <div className="space-y-3">
                {['Algebra - Quadratic Equations', 'Science - Periodic Table', 'English - Shakespeare'].map((note, i) => (
                  <div key={i} className="p-4 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition cursor-pointer flex justify-between items-center">
